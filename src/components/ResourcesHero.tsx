...
const ResourcesHero = () => (
  <div className="relative w-full h-64 md:h-80 flex items-center justify-center bg-gradient-to-br from-emerald-100 to-blue-100 mb-10 overflow-hidden rounded-b-3xl shadow-lg">
    ...
    <div className="relative z-10 text-center">
      <h1 className="text-4xl md:text-5xl font-bold gradient-text drop-shadow mb-4">Πόροι</h1>
      <p className="text-lg md:text-2xl text-gray-800 font-medium drop-shadow">Όλα τα εργαλεία, οδηγοί και υλικό για προπονητές & αθλητές.</p>
    </div>
  </div>
);
